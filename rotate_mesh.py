...
if __name__ == '__main__':
    ...
    parser.add_argument("--axis", choices=['x', 'y', 'z'], default='z', help="Rotation axis (default: z)")
    parser.add_argument("--center", nargs=3, type=float, help="Optional center of rotation (x y z)")

    args = parser.parse_args()

    rotate_geometry(args.input, args.output, args.angle, axis=args.axis, center=args.center)
